...
class TicketUserController extends Controller
{
    ...
    {
        // Retrieve the incoming request data without validation
        $escalationReason = $request->input('escalationReasonDue_to_clientNoncompliance');
        ...
        if ($ticketUser) {
            ...
            DB::table('ticket_user')
                ...
                ->where('user_id', Auth::id())
                ->update([
                    'escalationReasonDue_to_clientNoncompliance' => $escalationReason,
