...
<div class="modal fade" id="nicmuCreateEquipmentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="jobForm" action="{{ route('nicmus.storeEquipment') }}" method="POST">
                    @csrf
                    <div class="mb-3">
