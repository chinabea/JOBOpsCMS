    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ictramDeletedataWithRelationModal{{ $ictram->id }}Label">Confirm Delete</h5>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('ictrams.destroyIctram', $ictram->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
