                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('unassigned.report') }}" method="post"> @csrf <div class="row justify-content-center">
                            ...
                            </form> @if ($unassignedTickets->isEmpty()) <p>There are no unassigned tickets at the moment.</p> @else <table id="datatable-responsive" class="table table-bordered table-hover text-center table-striped table-sm">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                ...
                                <tbody> @foreach($unassignedTickets as $ticket) @if(auth()->user()->role == 1 || auth()->user()->id == $ticket->user_id || (auth()->user()->role == 2 && $ticket->assigned_to == auth()->id())) <tr>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Form inside modal -->
                                                            <form action="{{ route('tickets.updateUsers', $ticket->id) }}" method="POST"> @csrf <div class="form-group text-left">
