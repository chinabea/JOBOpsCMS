            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <p class="mb-4"></p>
                            <h1>Office Name: {{ $officeName->office_name }}</h1>
                            <p>ID: {{ $officeName->id }}</p>
                            <p>Created at: {{ $officeName->created_at }}</p>
                            <p>Updated at: {{ $officeName->updated_at }}</p>
                            <a href="{{ route('office-names.index') }}">Back to list</a>
                        </div>
                    </div>
                </div>
            </div>
