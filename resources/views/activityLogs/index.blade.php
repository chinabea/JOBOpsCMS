                                        ...
                                        <td>
                                            ...
                                            @elseif ($log->action === 'Created' || $log->action === 'Updated' || $log->action === 'Approved' || $log->action === 'Disapproved')
                                                ...
                                                @elseif ($log->model_type === 'App\Models\Ticket')
                                                    ...
                                                    <a href="{{ route('showTicketActivityLogs', $log->model_id) }}">{{ $log->subject->request ?? 'Clicked for Details' }}</a>
                                                ...
                                                @endif
                                            @else
                                                <a href="{{ route('showTicketActivityLogs', $log->model_id) }}">
                                                    {{ $log->subject->request ?? 'Clicked for Details' }}
                                                </a>
                                            @endif
                                        </td>
                                        </tr>
